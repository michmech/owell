...
Opening the Well is a website where volunteers transcribe recordings in Scottish Gaelic. To become a volunteer transcriber you need to [register](/en/register) first. Once you have registered you must [log in](/en/login) using your e-mail address and password. Then you can start transcribing.
...
![A tab on the home page lists recordings that are available for transcription](/en/001.png)
...
![A recording which is available for transcription](/en/002.png)
...
![A tab on the home page lists the recordings you are currently working on](/en/003.png)
...
1. Place the cursor in the white text box.
2. Press `Ctrl` + `Space` to start playback and listen to a few words.
3. When you have heard enough, press `Ctrl` + `Space` again to stop the playback.
4. Write down what you have heard.
5. Press `Ctrl` + `M` to insert a timestamp.
6. Repeat from step 2.

![A partially transcribed recording](/en/004.png)
...
![The segment currently being played is highlighted in the transcription](/en/005.png)

## A word about spelling and punctuation
...
## Getting help from automatic speech recognition
...
![A partial transcription, with ASR suggestions appearing at the end](/en/006.png)
...
## Saving and finishing your work
...
![The Save button is in the bottom right corner of the screen](/en/007.png)
...
![A pop-up menu showing the option to abandon a recording](/en/008.png)
...
![Congratulations, you have just transcribed a recording!](/en/009.png)
